            ...
            <div className="h-full flex flex-col px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul className="flex-grow overflow-y-auto space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/dashboard') ? activeStyles : inactiveStyles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/data-santri') ? activeStyles : inactiveStyles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/data-pengguna') ? activeStyles : inactiveStyles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg"fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/data-peraturan') ? activeStyles : inactiveStyles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/input-pelanggaran-santri') ? activeStyles : inactiveStyles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/profile-pengguna') ? activeStyles : inactiveStyles}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li>
                        ...
                        >
                            <svg class={`w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white ${currentRoute.includes('/atur-role') ? activeStyles : inactiveStyles}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
